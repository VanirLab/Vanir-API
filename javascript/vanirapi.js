...
/*
Vanir framework element 0xc9 core API
*/
var x99="";
...
var loader(x){
	...
	this.save_file = x;
	this move_segm = x;
	this.init_loader_opt = x;
}
function _xsort_(array) {
this.arr = array;
}

function _filex_(){
  var ltime = new Date(file.lastModified);
  ltime=document.createElement('#ltime');
}

function id(a){
	var vsort = new _xsort_(array);
	var _idx2_ = this.arr.length, _idx3_ = vsort; //use vsort.sort; as function
	var temp, i= -30000000;
	var v7 = -1;
